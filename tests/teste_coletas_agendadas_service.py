...
from services.coletas_agendadas_service import ColetasAgendadasService
...
resultado_listar = service.listar()
...
resultado_agendadas = service.pesquisar(
    status="AGENDADA",
)
...
resultado_hoje = service.agenda_hoje()
...
resultado_totais = service.total_por_status()
...
resultado_id_invalido = service.obter_por_id(
    0
)
...
resultado_data_invalida = service.pesquisar(
    data="31/07/2026",
)
...
resultado_periodo_invalido = service.agenda_periodo(
...
# ==========================================================
# LOCALIZA DADOS PARA O TESTE OPERACIONAL
# ==========================================================
...
resultado_agendar = service.agendar(
...
resultado_motorista = service.motorista_disponivel(
    motorista_id=motorista_id,
    data_hora_agendada=data_hora_futura,
)
...
resultado_veiculo = service.veiculo_disponivel(
    veiculo_id=veiculo_id,
    data_hora_agendada=data_hora_futura,
)
...
resultado_reagendar = service.reagendar(
    solicitacao_id=solicitacao_id,
...
resultado_iniciar = service.iniciar_coleta(
    solicitacao_id
)
...
resultado_concluir = service.concluir_coleta(
    solicitacao_id
)
...
resultado_reiniciar = service.iniciar_coleta(
    solicitacao_id
)
...
print(
    "\n=== TESTE DO COLETAS AGENDADAS SERVICE CONCLUÍDO ==="
)